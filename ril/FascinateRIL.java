...
* {@hide}
*/
public class FascinateRIL extends SamsungExynos3RIL implements CommandsInterface {
    public FascinateRIL(Context context, int networkMode, int cdmaSubscription) {
